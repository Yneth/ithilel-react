...
const EventsPage: FC = () => {
  ...
  const events =
    useAppSelector((state) => selectEventsFiltered(state, eventQuery)) || null;
  ...
  return (
    <WithPreloader isLoading={isLoading} blurAmount="0.1rem">
      <>
        {events && (
        ...
        {hasNoEvents && (
          ...
          >
            ...
            {hasQuery && (
              <Button component={Link} to={{ pathname: "", search: "" }}>
                Reset
              </Button>
            )}
          </Paper>
