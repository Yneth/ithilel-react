...
function* createEvent({
  payload,
}: PayloadAction<CreateEventRequest>): Generator<
  StrictEffect,
  any,
  EventResponse
> {
...
function* updateEvent({
  payload,
}: PayloadAction<UpdateEventRequest>): Generator<
  StrictEffect,
  any,
  EventResponse
> {
...
function* removeEvent({
  payload,
}: PayloadAction<string>): Generator<StrictEffect, any, void> {
  try {
